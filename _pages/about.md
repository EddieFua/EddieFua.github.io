...
2. Yan, Y., **Fu, Y.**, Ren, W., $\&$ Li, S. [Unanchoring the Mind: DAE-Guided Counterfactual Reasoning for Rare Disease Diagnosis](https://openreview.net/forum?id=bYUqizOfpx). **NeurIPS** Workshop on GenAI for Health: Potential, Trust, and Policy Compliance. 2025. (<span style="color: red;">Award Candidate</span>)

3. Yan, Y., **Fu, Y.**, Ren, W., $\&$ Li, S. [Unanchoring the Mind: DAE-Guided Counterfactual Reasoning for Rare Disease Diagnosis](https://openreview.net/forum?id=bYUqizOfpx). **ICML** Workshop on Models of Human Feedback for AI Alignment. 2025.
